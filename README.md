...
2. Instala las dependencias con
  npm install
3. Configura las variables de entorno: Crea un archivo .env en la raíz del proyecto y agrega tu conexión a Turso SQL:
  TURSO_DB_URL=<URL de tu base de datos>
  TURSO_DB_TOKEN=<Token de acceso>
